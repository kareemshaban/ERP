...
@include('layouts.side' , ['slag' => 2 , 'subSlag' => 7])


<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    @include('flash-message')
    <!-- Navbar -->
    @include('layouts.nav' , ['page_title' => __('main.basic_date')  . ' / ' .  __('main.tax') ])
    <!-- End Navbar -->
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0 border">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-md-center font-weight-bolder opacity-7">{{__('main.tax_rate')}}</th>
                                    <th class="text-center text-uppercase text-secondary text-md-center font-weight-bolder opacity-7">{{__('main.tax_type')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-labeled btn-secondary " onclick="EditModal({{$tax -> id}})">
