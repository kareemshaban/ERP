...
@include('layouts.side' , ['slag' => 10 , 'subSlag' => 32])


<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    @include('flash-message')
    <!-- Navbar -->
    @include('layouts.nav' , ['page_title' => __('main.purchases_return_report') ])
    <!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.purchases_return_report')}}</h6>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function showReport(fdate , tdate , warehouse ,bill_no , vendor) {
        var route = '{{route('purchases_return_report_search',[":fdate" , ":tdate" , ":warehouse" , ":bill_no" , ":vendor"] )}}';
