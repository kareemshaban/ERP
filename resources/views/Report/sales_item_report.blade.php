...
@include('layouts.side' , ['slag' => 10 , 'subSlag' => 26])


<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    @include('flash-message')
    <!-- Navbar -->
    @include('layouts.nav' , ['page_title' => __('main.sales_report_by_item') ])
    <!-- End Navbar -->
                    ...
                    <div class="card-header pb-0">
                        <div class="row">
                            <div class="col-6 text-start">
                                <h6>{{ __('main.sales_report_by_item')}}</h6>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#excute').click(function (){
            ...
            showReport(fromDate ,toDate , warehouse);

        });

    });

    function showReport(fdate , tdate , warehouse) {
        var route = '{{route('sales_item_report_search',[":fdate" , ":tdate" , ":warehouse"] )}}';
